...
if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
	file(GLOB RESOLVED_LIBS ${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg/*/*${LIB_SUFFIX})
	file(INSTALL ${RESOLVED_LIBS} DESTINATION ${CURRENT_PACKAGES_DIR}/debug/lib)
endif()
if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
	file(GLOB RESOLVED_LIBS ${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/*/*${LIB_SUFFIX})
	file(INSTALL ${RESOLVED_LIBS} DESTINATION ${CURRENT_PACKAGES_DIR}/lib)
endif()
